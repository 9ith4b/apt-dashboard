...
export function GlobalSearch() {
  ...
  return (
    <div className="relative hidden w-[min(32vw,30rem)] lg:block">
      <InputGroup className="bg-background shadow-none">
        ...
        <InputGroupInput
          ...
          placeholder="搜索事件、IOC、攻击者或报告"
          value={query}
        />
      </InputGroup>

      {open ? (
        <div className="absolute top-12 right-0 z-40 max-h-[28rem] w-[min(30rem,calc(100vw-2rem))] overflow-y-auto rounded-xl border border-border bg-popover p-2 text-popover-foreground shadow-xl">
          {resultQuery.isPending ? (
            ...
            results.map((result) => (
              <Link
                className="block rounded-lg p-3 transition-colors hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
